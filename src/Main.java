// Erstellen einer neuen öffentlicher Klasse
public class Main {

    // Erstellen einer neuen öffentlichen Main Methode
    public static void main(String[] args) {
        System.out.println("Hello World!"); //Hello World auf der Konsole aufgeben
